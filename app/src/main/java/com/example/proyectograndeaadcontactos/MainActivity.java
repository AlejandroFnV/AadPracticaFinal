...
public class MainActivity extends AppCompatActivity {
    ...
    private void initEvents() {
        if (askContactsPermissions()){
            ArrayList<String> showContactsPhone = obtenerListaTelefonos(mostrarNombreContactos());
            typeContactsInTextView(mostrarNombreContactos(), showContactsPhone);
        }else{
            tvContactos.setText(R.string.aceptarPermisos);
        }
    }

    private ArrayList<String> obtenerListaTelefonos(List<Contacto> showContactsName) {
        ArrayList <String> showContactsPhone = new ArrayList<>();
        for (int i= 0; i<showContactsName.size();i++){
            showContactsPhone.add(String.valueOf(mostrarTelefonoContactos(showContactsName.get(i).getId())));
        }
    ...
    public List<Contacto> mostrarNombreContactos(){
    ...
    public List<String> mostrarTelefonoContactos(long id){
    ...
    private boolean askContactsPermissions() {
